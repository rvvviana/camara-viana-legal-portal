          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-2">
                ...
                <a
                  href="tel:+5561933909991"
                  className="font-montserrat text-gray-300 hover:text-secondary transition-colors"
                >
                  +55 61 9339-0991
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:contato@camaraviana.com"
                  className="font-montserrat text-gray-300 hover:text-secondary transition-colors"
                >
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="https://instagram.com/camaraviana"
                  target="_blank"
